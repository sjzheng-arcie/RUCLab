var rootIcon = "images/tree_img/root_close.gif"; 	//��Ŀ¼����ʱ״̬ͼ��
var openRootIcon = "images/tree_img/root_open.gif"; 	//��Ŀ¼չ��ʱ״̬ͼ��
var folderIcon = "images/tree_img/folder_close.gif";	//���ļ��й���ʱ״̬ͼ��
var openFolderIcon = "images/tree_img/folder_open.gif";	//���ļ���չ��ʱ״̬ͼ��
var fileIcon = "images/tree_img/tree_linker.gif";	//����Ҷ�ӽڵ�ͼ��
var iIcon = "images/tree_img/i_line.gif";		//��ͨ�������ߣ�ֱ�ģ�
var lIcon = "images/tree_img/l_line.gif";		//���һ���ڵ��������
var lMinusIcon = "images/tree_img/l_point_open.gif";	//���һ���ļ��нڵ㣨չ��ʱ�ģ�ͼ��
var lPlusIcon = "images/tree_img/l_point_close.gif";//���һ���ļ��нڵ㣨����ʱ�ģ�ͼ��
var tIcon = "images/tree_img/t_line.gif";		//�м�ڵ��������
var tMinusIcon = "images/tree_img/t_point_open.gif";	//�м��ļ��нڵ㣨չ��ʱ�ģ�ͼ��
var tPlusIcon = "images/tree_img/t_point_close.gif";//�м��ļ��нڵ㣨����ʱ�ģ�ͼ��
var blankIcon = "images/tree_img/blank.gif";		//�м�հ׵�ͼ��ͼ��
...
//    }
    ...
    for (var i = 0; i < objs.length; i++) {
        // alert("checked="+i+" �Ƿ��: "+obj.checked+"  size=="+objs[i].id.length+" ����ȡ����ֵ:"+obj.id.substr(0,objs[i].id.length)+"   ��ѡ��idֵ= "+obj.id);
        if (obj.checked && obj.id.substr(0, objs[i].id.length) == objs[i].id) {
            //  alert("��ǰ�򹴵ı���Ϊ:"+objs[i].id);
            objs[i].checked = true;
        }
    }
    for (var i = 0; i < objs.length; i++) {
    ...
    if (obj.checked) {
        ...
        //���˼���Ĵ���
        var len = obj.id.length;   //��ȡ��ѡȡ�����id����
        var stk = obj.id.substr(0, len - 2);  //��ȡ��ѡ��������λ����ı���
        // for( var j=0;j<len
        //ͬĿ¼���Ƿ��б�ѡ

        for (var i = 0; i < objs.length; i++) {  //��ͬ���б�ѡȡ�������������
            if (objs[i].id.length == len && objs[i].id.substr(0, len - 2) == stk && objs[i].checked && objs[i] != obj) {
                return true;
            }
        }
        for (var i = 0; i < objs.length; i++) {  //��ͬ���б�ѡȡ�����ϼ�ȡ��ѡ��
            if (objs[i].id == stk) {
...
function seltree() {
    /*var srcElement = event.srcElement;//��ǰѡ���Ķ���
     ...
     var strMenuId =  arrayOfStrings[0];//ѡ�е�checkbox��ֵ
