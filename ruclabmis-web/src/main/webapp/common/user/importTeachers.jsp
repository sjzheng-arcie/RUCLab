...
<body>
<form name="importTeachers" method="post" id="importTeachers" action="${ctx}/common/user/importTeachers"
        ...
        <tr>
            ...
            <td valign="top" background="../../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">基础信息管理>教师信息导入</div>
                        </td>
                    </tr>
                </table>
            </td>
