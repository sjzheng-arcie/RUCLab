...
scheduler.form_blocks.recurring = {render: function () {
    ...
    function h(a) {
        ...
        var c = "";
        if (g.end[0].checked)a.end = new Date(9999, 1, 1), c = "no"; else if (g.end[2].checked)a.end = j(g.date_of_end.value); else {
    ...
    var q = {month: function (a, b) {
        ...
        a[2] == "" ?
            (g.year_type[0].checked = !0, g.year_day.value = b.start.getDate(), g.year_month.value = b.start.getMonth()) : (g.year_type[1].checked = !0, g.year_week2.value = a[3], g.year_day2.value = a[2], g.year_month2.value = b.start.getMonth())
    }};
    ...
    scheduler._lightbox._rec_init_done ||
    d._init_set_value(a, b, c);
    a.open = !c.rec_type;
    ...
    if (a.open) {
        ...
        c._start ? (b.start_date = new Date(c.start), b._start_date = new Date(c.start),
            c._start = !1) : b._start_date = null;
        b._end_date = c.end;
...
scheduler.attachEvent("onBeforeEventDelete", function (a) {
    ...
    if (a.toString().indexOf("#") != -1 || b.event_pid && b.event_pid != "0" && b.rec_type && b.rec_type != "none") {
        ...
        var h = this._get_rec_markers(a), i;
        for (i in h)if (h.hasOwnProperty(i))a =
            h[i].id, this.getEvent(a) && this.deleteEvent(a, !0)
    }
    return!0
});
scheduler.attachEvent("onEventChanged", function (a) {
    ...
    if (a.toString().indexOf("#") != -1) {
        ...
        for (h in e)e.hasOwnProperty(h) && (delete this._rec_markers[e[h].id],
            this.deleteEvent(e[h].id, !0));
...
scheduler.repeat_date = function (a, b, c, d, f) {
    ...
    for (; e < f && e < a.end_date;) {
        var h =
            scheduler.config.occurrence_timestamp_in_utc ? Date.UTC(e.getFullYear(), e.getMonth(), e.getDate(), e.getHours(), e.getMinutes(), e.getSeconds()) : e.valueOf(), i = this._get_rec_marker(h, a.id);
