...
<head>
    ...
    <script>
        var baseHref = '/laboratory/jsp/sys/datatype/list';
    </script>
        ...
        <tr>
            ...
            <td valign="top" background="../../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">系统管理 > 数据字典类型</div>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#F7F8F9">
                    <tr>
                        <td valign="top" class="STYLE10">
                            ...
                            <span style="white-space:nowrap">&nbsp;&nbsp;字典名称:<input type="text" name="name"
                                                                                     id="name" value=""
                                                                                     style="width:100px;"/></span>
                            <span style="white-space:nowrap">&nbsp;&nbsp;字典类型:<input type="text" name="type"
                                                                                     id="type" value=""
                                                                                     style="width:100px;"/></span>
	<span style="white-space:nowrap">&nbsp;&nbsp;状态:<select>
        <option>有效</option>
        <option>无效</option>
    </select></span>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="94%" valign="bottom"><span
                                                                                class="STYLE1"
                                                                                style="white-space:nowrap">数据字典类型列表</span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                            ...
                                            <table width="100%" class="table" id="table1" border="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="80" height="20" bgcolor="d3eaef" class="STYLE6">
                                                        <div align="center"><span class="STYLE10">字典编号</span></div>
                                                    </td>
                                                    <td width="40" height="20" bgcolor="d3eaef" class="STYLE6">
                                                        <div align="center"><span class="STYLE10">字典名称</span></div>
                                                    </td>
                                                    <td width="100" height="20" bgcolor="d3eaef" class="STYLE6">
                                                        <div align="center"><span class="STYLE10">字典类型</span></div>
                                                    </td>
                                                    <td width="100" height="20" bgcolor="d3eaef" class="STYLE6">
                                                        <div align="center"><span class="STYLE10">字典描述</span></div>
                                                    </td>
