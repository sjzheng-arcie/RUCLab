...
<head>
    ...
    <script>
        var baseHref = '/laboratory/jsp/task/scoitem/list';
    </script>
...
<form name="listForm" method="post">
    <table width="98%" border="0" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td valign="top" background="../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">审核管理 > 评分项管理</div>
                        </td>
                    </tr>
                </table>
            </td>
		...
		<span style="white-space:nowrap">&nbsp;&nbsp;所属专业:<select id="theMajor" name="theMajor">
            <option value=""></option>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="94%" valign="bottom"><span
                                                                                class="STYLE1"
                                                                                style="white-space:nowrap">评分项列表</span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                            ...
                                            <table width="100%" class="table" id="table1" border="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">评分项编号</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">评分项名称</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">所占比重</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
