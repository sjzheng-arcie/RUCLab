...
<td valign="top" class="STYLE10">
                    ...
                    <span style="white-space:nowrap">
                        任务名<input type="text" name="typeName"
                                  id="typeName" value=""
                                  style="width:100px;"/>
                    </span>
                ...
                <table id="treeTable" class="table" width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                    ...
                    <c:forEach items="${pageInfo.data}" var="item">
                        <tr bgcolor="#ffffff" align="center" class="STYLE19">
                            ...
                            <td height="20">${item.typeName}</td>
                            <td><a href="/laboratory/jsp/task/tasktype/toupdate?id=${item.id}">
                                <img src="../../../../images/edit_min.gif" width="10"
                                     height="10" border="0"/>
                            </a></td>
                            <td><a href="/laboratory/jsp/task/tasktype/delete?id=${item.id}">
