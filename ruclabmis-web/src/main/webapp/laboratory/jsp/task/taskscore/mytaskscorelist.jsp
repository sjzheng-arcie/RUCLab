                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#F7F8F9">
                    <tr>
                        <td valign="top" class="STYLE10">
                            ...
                            <%--&lt;%&ndash;<span style="white-space:nowrap">&nbsp;&nbsp;负责人:&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<select id="managerId" name="managerId"&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;style="width: 252px;height: 22px"&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;data-placeholder="选择负责人...">&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<option value=""></option>&ndash;%&gt;--%>
                                <%--&lt;%&ndash;<c:forEach items="${managerList}" var="manager">&ndash;%&gt;--%>
                                    <%--&lt;%&ndash;<option value="${manager.id}">${manager.name}(${manager.sn})</option>&ndash;%&gt;--%>
                                            ...
                                            <table id="table1" width="100%" class="table" border="0" cellpadding="0"
                                                ...
                                                <c:forEach items="${pageInfo.data}" var="item">
                                                    <tr bgcolor="#ffffff" align="center" class="STYLE19">
                                                        ...
                                                        <td><fmt:formatDate value="${item.task.limitdate}"/></td>
                                                        <td>${item.task.content}</td>
                                                        <td>

                                                            <a class="button" href="/laboratory/jsp/task/taskscore/torescore?taskScoreId=${item.id}">查看</a>
