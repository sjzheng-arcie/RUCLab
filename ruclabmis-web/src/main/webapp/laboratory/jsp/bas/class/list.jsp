...
<head>
    ...
    <script>
        ...
        var baseHref = '/laboratory/jsp/bas/class/list';
        ...
        <tr>
            ...
            <td valign="top" background="../../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">基础信息管理 > 班级信息管理</div>
                        </td>
                    </tr>
                </table>
            </td>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="94%" valign="bottom"><span
                                                                                class="STYLE1"
                                                                                style="white-space:nowrap">班级信息管理</span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <div id="divwidth" style="overflow:auto;overflow-y:hidden;">
                                            <table width="100%" class="table" id="table1" border="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">入学年份</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">入学季度</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">学历类型</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">班级类型</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">学制</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">人数</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">班主任</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                    ...
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">所属专业</span></div>
                                                    </td>
