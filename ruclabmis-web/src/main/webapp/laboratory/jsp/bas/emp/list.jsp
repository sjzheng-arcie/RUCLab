        ...
        <tr>
            ...
            <td valign="top" background="../../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">基础信息管理 > 教职工信息管理</div>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#F7F8F9">
                    <tr>
                        <td valign="top" class="STYLE10">
                            ...
                            <span style="white-space:nowrap">&nbsp;&nbsp;教职工姓名:<input type="text" name="teacherName"
                                                                                      id="teacherName" value=""
                                                                                      style="width:100px;"/></span>
		<span style="white-space:nowrap">&nbsp;&nbsp;教职工编号:<select id="teacherNo" name="teacherNo">
            <option value=""></option>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="94%" valign="bottom"><span
                                                                                class="STYLE1"
                                                                                style="white-space:nowrap">教职工信息列表</span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
