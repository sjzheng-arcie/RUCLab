        ...
        <tr>
            ...
            <td valign="top" background="../../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">基础信息管理 > 学年学期修改</div>
                        </td>
                    </tr>
                </table>
            </td>
                                ...
                                <tr bgcolor="#FFFFFF">
                                    <td bgcolor="#FFFFFF">
                                        <table border="0" cellpadding="2" cellspacing="1"
                                               ...
                                               bgcolor="#E3E9EE">
                                            <input name="id" id="id" type="hidden" value="${termYear.id}">
                                            <tr>
                                                <td nowrap align="right">学期名称:</td>
                                                <td nowrap>
                                                    <input name="name" id="name" value="${termYear.name}" onblur="" class="text"
                                                ...
                                                <td nowrap>
                                                    <input name="year" id="year" value="${termYear.year}" onblur="" class="text"
                                            ...
                                            <tr>
                                                ...
                                                <td nowrap>
                                                    <input name="startweek" id="startweek" value="${termYear.startweek}" onblur=""
                                                ...
                                                <td nowrap>
                                                    <input name="endweek" id="endweek" value="${termYear.endweek}" onblur=""
                                                           class="text" style="width:154px" maxlength="20"
                                                           valid ="required|isNumber"
                                            ...
                                            <td>
                                                <input name="begindate" id="begindate"
                                                       value="<fmt:formatDate value="${termYear.begindate}" pattern="yyyy-MM-dd"/>"
