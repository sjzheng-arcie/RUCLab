...
<body>
<form name="importCurriculums" method="post" id="importCurriculums" action="${ctx}/laboratory/jsp/bas/curriculum/importCurriculums"
        ...
        <tr>
            ...
            <td valign="top" background="../../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">基础信息管理>课程信息导入</div>
                        </td>
                    </tr>
                </table>
            </td>
