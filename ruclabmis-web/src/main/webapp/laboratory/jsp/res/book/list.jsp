...
<head>
    ...
    <script>
        function toUpload(){
            document.listForm.action="/laboratory/jsp/res/book/toUpload";
                    ...
                    <tr>
                        <td valign="top" class="STYLE10">
                                    <span style="white-space:nowrap">&nbsp;&nbsp;资源名称.:
                                        <input type="text" name="rsourceName"id="rsourceName" value=""style="width:100px;"/>
                                    </span>
                                    <span style="white-space:nowrap">&nbsp;&nbsp;资源类型:
                                    ...
                                    <span style="white-space:nowrap">&nbsp;&nbsp;所属课程:
                                        <select id="theCourse" name="theCourse">
                                            <option value=""></option>
                                            <c:forEach items="${theCourseList}" var="item">
                                                <option  value="${item.id}">
                                                        ${item.name}
                                                </option>
                                            </c:forEach>
                                    ...
                                    <span style="white-space:nowrap">&nbsp;&nbsp;
                                        <a href="javascript:void(0);"style="cursor:hand"onclick="findInfo()">
                                            ...
                                            <table width="100%" class="table" id="table1" border="0" cellpadding="0"
                                                ...
                                                <c:forEach items="${pageInfo.data}" var="item">
                                                    <tr bgcolor="#ffffff" align="center" class="STYLE19">
                                                        ...
                                                        <td>${item.limit}</td>
                                                        <shiro:hasAnyRoles name="teacher,administrators">
                                                            <c:if test="${item.uploader=='<shiro:principal/>'}">
