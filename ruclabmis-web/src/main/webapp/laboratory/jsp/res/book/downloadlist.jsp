...
<head>
    ...
    <script>
        var baseHref = '/laboratory/jsp/res/book/downloadList';
    </script>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#F7F8F9">
            <tr>
                <td valign="top" class="STYLE10">
                            ...
                            <span style="white-space:nowrap">&nbsp;&nbsp;资源名称.:<input type="text" name="searchB1"
                                                                                      id="searchB1" value=""
                                                                                      style="width:100px;"/></span>
		<span style="white-space:nowrap">&nbsp;&nbsp;资源类型:<select id="searchD1" name="searchD1">
