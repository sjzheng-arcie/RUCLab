...
<head>
    ...
    <script>
        function makeDocumentFromSubject() {
            ...
            $.post("/laboratory/jsp/res/instruction/addSubject", {
                'instructionName': $('#instructionName').val(),
...
<form name="listForm" method="post">
    <input name="instructionName" id="instructionName" type="hidden" value="${instructionName}">
        ...
        <tr>
            ...
            <td valign="top" background="../../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
                    <tr>
                        <td height="31">
                            <div class="titlebt">指导书修改 > 添加实验题到指导书</div>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#F7F8F9">
                    <tr>
                        <td valign="top" class="STYLE10">
                         ...
                         <span style="white-space:nowrap">实验题名称:<input type="text" name="questionName"
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="94%" valign="bottom"><span
                                                                                class="STYLE1"
                                                                                style="white-space:nowrap">实验题列表</span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                            ...
                                            <table width="100%" class="table" id="table1" border="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="100" height="20" bgcolor="d3eaef" class="STYLE6">
                                                        <div align="center"><span class="STYLE10">实验题名称</span></div>
                                                    </td>
                                                </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center">
                                        ...
                                        <input type="button" name="button" value="生成指导书" class="button"
