...
<head>
    ...
    <script>
        ...
        function upload() {
            ...
            if (file) {
                document.mainForm.action = "uploadFile";
                document.mainForm.submit();
            } else {
                alert("请选择要上传的文件!");
            }
        ...
        function deleteFile() {
            var file = document.getElementById("file").value;
            if (file) {
                document.mainForm.action = "deleteFile";
                document.mainForm.submit();
            } else {
                alert("请选择要上传的文件!");
            }
                            ...
                            <td bgcolor="#FFFFFF">
                                <table border="0" cellpadding="2" cellspacing="1"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <textarea name="purpose" style="width:90%;height:30px"
                                                      valid="required"
                                                      errmsg="实验目的不能为空!">${instruction.purpose}
                                            </textarea>
                                            <span style="color:red;"> *</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <textarea name="explanation" style="width:90%;height:60px"  valid="required"
                                                      errmsg="实验说明不能为空!">${instruction.explanation}
                                            </textarea>
                                            <span style="color:red;"> *</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="file" name="file" id="file" class="buttom" value="浏览"/>
                                            <input type="button" value="上传" class="buttom" onclick="upload();"/>
                                        </td>
                                    </tr>
                                    ...
                                    <c:forEach items="${documents}" var="doc">
                                        <tr>
                                            <td/>
                                            <td>${doc}
                                                <input type="button" value="下载" class="buttom" onclick=""/>
                                                <input type="button" value="删除" class="buttom" onclick=""/>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                            ...
                                            <td width="40" height="20" bgcolor="d3eaef" class="STYLE10">
                                                <div align="center">
                                                    <input type="checkbox" name="checkbox" id="checkbox"
                                                           onclick="checkAll(this,'mainForm', 'idcheckbox');"/>
                                                </div>
                                            </td>
                                        ...
                                        <c:forEach items="${pageInfo.data}" var="item">
                                            <tr bgcolor="#ffffff" align="center" class="STYLE19">
                                                <td height="20"><input name="idcheckbox" type="checkbox"
                                                                       value="${item.id}" onclick="checkOne('mainForm', 'idcheckbox')"/>
                                                </td>
                                                <td>${item.name}</td>
