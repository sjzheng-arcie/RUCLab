...
<head>
    ...
    <script>
        var baseHref = '/laboratory/jsp/res/experimentpaper/list';
    </script>
        ...
        <tr>
            ...
            <td valign="top" background="../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">资源管理 > 实验管理</div>
                        </td>
                    </tr>
                </table>
            </td>
                                        ...
                                        <div id="divwidth" style="overflow:auto;overflow-y:hidden;">
                                            <table width="100%" class="table" id="table1" border="0" cellpadding="0"
                                                ...
                                                <tr bgcolor="#ffffff" align="center" class="STYLE19">
                                                    ...
                                                    <td>模拟电路基础型实验实验指导书</td>
                                                    <td>模拟电路基础型实验报告书</td>
                                                    <td>实验题描述</td>
                                                    <td><a href="editpaper.html">查看实验</a></td>
                                                    <td><a href="editpaper.html">编辑实验</a></td>
                                                </tr>
                                                <tr bgcolor="#ffffff" align="center" class="STYLE19">
                                                    <td height="20"><input name="idcheckbox" type="checkbox"
                                                                           value="admin" onclick="checkOne(this)"/></td>
                                                ...
                                                <tr bgcolor="#ffffff" align="center" class="STYLE19">
                                                    ...
                                                    <td>嵌入式输入设备设计实验指导书</td>
                                                    <td>嵌入式输入设备设计实验报告书</td>
                                                    <td>嵌入式输入设备设计</td>
                                                    <td><a href="editpaper.html">查看实验</a></td>
                                                    <td><a href="editpaper.html">编辑实验</a></td>
                                                </tr>
