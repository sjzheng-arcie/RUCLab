                                ...
                                <fmt:formatDate value="${item.publishTime}"></fmt:formatDate>
                                                    ...
                                                    <form name="listForm">
                                                        ...
                                                        <table border='0' align='right' cellpadding='0' cellspacing='0'
                                                            ...
                                                            <tr>
                                                                <td width='49'>
                                                                    <div align='center'><img onclick="goPage(1)"
                                                                                             style="cursor:hand"
                                                                                             src='../../../../images/main_54.gif'
                                                                                             width='40' height='15'
                                                                                             border='0'/></div>
                                                                </td>
                                                                <td width='49'>
                                                                ...
                                                                <td width='49'>
                                                                    <div align='center'><img
                                                                            ...
                                                                            style="cursor:hand"
                                                                            src='../../../../images/main_60.gif'
                                                                            width='40' height='15'
                                                                            border='0'/></div>
                                                                </td>
                                                                <td width='37' class='STYLE22'>
                                                                    <div align='center' style="white-space:nowrap">转到
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div align='left'>
                                                                        <select onchange="goPage(this.options[this.selectedIndex].value)">
                                                                            <c:forEach var="i" begin="1"
                                                                                ...
                                                                                <option class='STYLE22' value='${i}'
                                                                                        <c:if test="${page.currentPage == i}">selected</c:if> >
                                                                                    第${i}页
                                                                                </option>
                                                                            </c:forEach>
                                                                        </select>
