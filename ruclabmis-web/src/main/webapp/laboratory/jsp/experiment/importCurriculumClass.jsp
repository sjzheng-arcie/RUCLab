...
<body>
<form name="importCurriculumClass" method="post" id="importCurriculumClass" action="${ctx}/laboratory/jsp/experiment/experiment/importCurriculumClass"
        ...
        <tr>
            ...
            <td valign="top" background="../../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">实验教学管理>班级信息导入</div>
                        </td>
                    </tr>
                </table>
            </td>
