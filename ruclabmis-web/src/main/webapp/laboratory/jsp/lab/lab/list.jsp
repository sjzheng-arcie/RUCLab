...
<span style="white-space:nowrap">&nbsp;&nbsp;实验室编号:<input type="text" name="searchB1" id="searchB1" value=""
                                                          style="width:100px;"/></span>
<span style="white-space:nowrap">&nbsp;&nbsp;实验室名称:<input type="text" name="searchB1" id="searchB1" value=""
                                                          style="width:100px;"/></span>
            ...
            <div id="divwidth" style="overflow:auto;overflow-y:hidden;">
                <table id="hello" width="100%" border="1" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                    <tr>
                        ...
                        <td width="100" height="20" bgcolor="d3eaef" class="STYLE6">
                            <div align="center"><span class="STYLE10">配备设备</span></div>
                        </td>

                        <td width="100" height="20" bgcolor="d3eaef" class="STYLE6">
                            <div align="center"><span class="STYLE10">库存设备</span></div>
                        </td>
