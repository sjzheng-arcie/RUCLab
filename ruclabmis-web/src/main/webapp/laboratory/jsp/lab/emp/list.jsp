        ...
        <tr>
            ...
            <td valign="top" background="../../../images/content-bg.gif">
                <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
                    ...
                    <tr>
                        <td height="31">
                            <div class="titlebt">实验室管理 > 实验室人员管理</div>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#F7F8F9">
                    <tr>
                        <td valign="top" class="STYLE10">
                            ...
                            <span style="white-space:nowrap">&nbsp;&nbsp;教职工姓名:<input type="text" name="searchB1"
                                                                                      id="searchB1" value=""
                                                                                      style="width:100px;"/></span>
		<span style="white-space:nowrap">&nbsp;&nbsp;教职工编号:<select id="searchD1" name="searchD1">
            <option value=""></option>
                                                                ...
                                                                <table width="100%" border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td width="94%" valign="bottom"><span
                                                                                class="STYLE1"
                                                                                style="white-space:nowrap">实验室人员列表</span>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <div id="divwidth" style="overflow:auto;overflow-y:hidden;">
                                            <table width="100%" class="table" id="table1" border="0" cellpadding="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">岗位</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">所属实验室</span></div>
                                                    </td>
                                                    <td width="100" bgcolor="d3eaef">
                                                    ...
                                                    <td width="100" bgcolor="d3eaef">
                                                        <div align="center"><span class="STYLE10">人员日志</span></div>
                                                    </td>
                                                ...
                                                <tr bgcolor="#ffffff" align="center" class="STYLE19">
                                                    ...
                                                    <td title="">软件工程指导老师</td>
                                                    <td title="">软件实验室一</td>
                                                    <td title="">软件实验房间一</td>

                                                    <td title="">dasa@sd.com</td>
                                                    <td title="">8828123</td>
                                                    <td title=""><a href="loglist.html">人员日志</a></td>
                                                </tr>
