                ...
                <tr valign="top">
                    <td>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td align="center">
                                    <a  class="button" href="/laboratory/jsp/lab/house/list?page=${houseListPage}&roomId=${roomInfo.id}" name="return"  class="button">返回</a>
                                </td>
                            </tr>
                        </table>
                    </td>
                                                            ...
                                                            <div align="right">
                                                                    <span class="STYLE1" style="white-space:nowrap">
                                                                        <a href="toadd?roomId=${roomInfo.id}&laboratoryId=${laboratoryInfo.id}" class="txt_bt">
                                                                         ...
                                                                         <a href="javascript:;" onclick="toDelete('mainForm','idcheckbox');" class="txt_bt">
