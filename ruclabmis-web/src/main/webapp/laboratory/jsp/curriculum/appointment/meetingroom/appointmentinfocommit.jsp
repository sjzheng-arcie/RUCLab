                ...
                <tr>
                    <td height="27">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="op_nor" onclick="javascript:location.href='page02_hysyy_new.html'">预约基本信息
                                </td>
                                ...
                                <td class="op_act" onclick="javascript:location.href='page02_hysyy_yl.html'">预约信息提交</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td valign="top" height="420">
                        <div id="zuoxi" style="width: 100%; height: 100%; overflow: auto; display: none;">
                            <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                ...
                                <tr height="25">
                                    <td width="15%" align="right" bgcolor="#e3efff">会议名称：</td>
                                    <td width="35%" bgcolor="#f7f7f7">新系统上线启动会</td>
                                    <td width="15%" align="right" bgcolor="#e3efff">会议类型：</td>
                                    <td width="35%" bgcolor="#f7f7f7">全体大会</td>
                                </tr>
                                <tr height="25">
                                ...
                                <tr height="25">
                                    ...
                                    <td align="right" bgcolor="#e3efff">预约会议室：</td>
                                    <td bgcolor="#f7f7f7">101</td>
                                </tr>
                                <tr height="25">
                                    <td align="right" bgcolor="#e3efff">会议内容：</td>
                                    <td colspan="3" bgcolor="#f7f7f7">
                                        新实验室管理系统上线启动会议，演示新系统特性，动员大家积极使用。
                                    </td>
                                </tr>
                                <tr height="25">
                                    <td align="right" bgcolor="#e3efff">备注信息：</td>
                                    <td colspan="3" bgcolor="#f7f7f7">全体成员参加。</td>
                                </tr>
                            </table>
                            <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                <tr height="25">
                                ...
                                <tr height="25">
                                    <td bgcolor="#F7F7F7">联想投影机</td>
                                    <td bgcolor="#F7F7F7">投影机</td>
                                    <td bgcolor="#F7F7F7">1</td>
                                    <td bgcolor="#F7F7F7">1</td>
                                </tr>
                                <tr height="25">
                                    <td bgcolor="#F7F7F7">飞利浦调音台</td>
                                    <td bgcolor="#F7F7F7">调音台</td>
                                    <td bgcolor="#F7F7F7">1</td>
                                    <td bgcolor="#f7f7f7">1</td>
                                </tr>
                                <tr height="25">
                                    <td bgcolor="#F7F7F7">山水音响</td>
                                    <td bgcolor="#F7F7F7">音响</td>
                        ...
                        function doOnLoad() {
                            ...
                            dhxToolbar.attachEvent("onClick", function (id) {
                                switch (id) {
                                    ...
                                    case 'tijiao' :
                                        alert("方案已提交相关领导审批!")
                                        window.location.href = 'page02_hysyy.html';
                                        break;
                                    case 'prev' :
                                        window.location.href = 'page02_hysyy_zy.html';
                                        break;
                                    case 'next' :
                                        alert("已经到最后一步!")
                                        break;
