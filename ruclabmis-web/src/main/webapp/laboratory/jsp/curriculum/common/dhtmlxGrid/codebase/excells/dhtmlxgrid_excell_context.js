...
function eXcell_context(a) {
    ...
    this.setValue = function (b) {
        this.cell._val = b;
        var a = this._sub.itemPull[this._sub.idPrefix + this.cell._val], b = a ? a.title : b;
        this.setCValue(b || "&nbsp;", b)
    };
    this.edit = function () {
        var b = this.grid.getPosition(this.cell);
        this._sub.showContextMenu(b[0] + this.cell.offsetWidth, b[1]);
...
dhtmlXGridObject.prototype.setSubContext = function (a, b, d) {
    ...
    if (!this._sub_context)this._sub_context = [];
