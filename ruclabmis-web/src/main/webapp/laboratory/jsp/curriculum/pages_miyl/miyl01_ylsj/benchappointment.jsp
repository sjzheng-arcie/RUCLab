                    ...
                    <td height="27">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="op_nor" onclick="javascript:location.href='deviceapply'">实验设备申请</td>
                                <td class="op_nor" onclick="javascript:location.href='appoibntmentinfosubmit'">预约信息提交</td>
                            </tr>
                        </table>
                    </td>
                </tr>
