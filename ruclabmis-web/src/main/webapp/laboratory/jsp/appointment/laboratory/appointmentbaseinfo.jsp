...
<script>
    function seekStatus()
    {
        var getStr =  "/laboratory/jsp/appointment/laboratory/roomstatus?";
        ...
        <tr>
            ...
            <td valign="top" bgcolor="#F7F8F9">
                <table  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#a8c7ce">
                    <tr valign="top">
                        <td>
                            <table  style="width:100%;height:370px"  border="0" cellpadding="2" cellspacing="2" bgcolor="#a8c7ce">
                                <tr bgcolor="#E3E9EE">
                                    <td bgcolor="#E3E9EE">
                                        <table border="0" cellpadding="10" cellspacing="10"
                                            ...
                                            <tr>
                                                ...
                                                <td width="100">
                                                    <select id="week" name="week" style="width: 150px;height: 22px">
                                            ...
                                            <tr>
                                                ...
                                                <td width="100">
                                                    <select id="day" name="day" style="width: 150px;height: 22px">
                                            ...
                                            <tr>
                                                ...
                                                <td width="100">
                                                    <select id="section" name="section" style="width: 150px;height: 22px">
