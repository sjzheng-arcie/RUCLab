...
<script>
    function selectTable(roomIndex) {
        var getStr =  "/laboratory/jsp/appointment/laboratory/toMultiAdd?";
        getStr +=  "startTime=" + "${startTime}";
        getStr +=  "&endTime=" + "${endTime}";
        getStr +=  "&beginWeek=" + "${beginWeek}";
        getStr +=  "&endWeek=" + "${endWeek}";
        getStr +=  "&weekDay=" + "${weekDay}";
        getStr +=  "&termYearId=" + "${termYearId}";
        getStr +=  "&appointmentType=" + "${appointmentType}";
