                ...
                <tr>
                    <td valign="top" height="420">
                        <table border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="op_nor" onclick="javascript:location.href='page01_ylya_new.html'">预约基本信息</td>
                                <td class="op_act" onclick="javascript:location.href='page01_ylya_rc.jsp'">预约日程</td>
                                <td class="op_nor" onclick="javascript:location.href='page01_ylya_zx.html'">实验室申请</td>
                                <td class="op_nor" onclick="javascript:location.href='page01_ylya_zy.html'">实验设备申请</td>
                                <td class="op_nor" onclick="javascript:location.href='page01_ylya_yl.html'">预约信息提交</td>
                            </tr>
                        </table>
                        ...
                        function doOnLoad() {
                            ...
                            dhxToolbar.attachEvent("onClick", function (id) {
                                switch (id) {
                                    case 'save' :
                                        ...
                                        break;
                                    case 'prev' :
                                        window.location.href = 'page01_ylya_new.html';
                                        break;
                                    case 'next' :
                                        window.location.href = 'page01_ylya_zx.html';
                                        break;
                                    default:
                            ...
                            dhxLayout.cells("a").setText("房间");
                            dhxLayout.cells("a").attachURL("page01_ylya_zx2_cont.html");
                            
                            dhxLayout.cells("b").setText("占用情况");
             								dhxLayout.cells("b").attachURL("page01_ylya_rc_cont.html");
                        }</script>
                </tr>
            </table>
        </td>
