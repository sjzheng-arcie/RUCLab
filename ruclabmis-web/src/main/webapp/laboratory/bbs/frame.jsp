...
<head>
    ...
    <script language="javascript" type="text/javascript">
        window.onerror = function (msg, line, url) {
            return true;
        }
    </script>
...
<div id="ajaxwaitid" style=" background-repeat:no-repeat"></div>
<div class="wrap">
<div id="header">
    <!--logo&banner-->
    <div id="banner" style="background-image:url('images/default/banner_mole_bg.jpg');border:0;position:relative;">
        <div style="position:absolute; left:0px; top:0px; z-index:99px;"><img src="images/default/banner_mole_left.jpg"
...
<style type="text/css">
    ...
    .index_box_main_sqtt li {
        margin: 10px auto;
    }

    .index_box_main_sqtt h1 {
        font-size: 14px;
        font-weight: 100;
    }

    .index_box_main_sqtt h2 {
        font-size: 12px;
        font-weight: 100;
        color: #999999;
    }
...
<script type="text/javascript">
    try {
        var pageTracker = _gat._getTracker("UA-12104138-11");
