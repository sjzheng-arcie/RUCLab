...
<div style="border: 1px;">
                ...
                <c:forEach items="${messageLists}" var="item">
                    ...
                    <div class="message" style="border: 1px;">
                        ...
                        <hr class="hr1">
                        <p align="left"><a href="/equipment/jsp/announcement/remind/messageDetail?messageDetailId=${item.id}">查看详细</a><a href="/equipment/jsp/announcement/remind/deleteMessage">删除该条信息</a></p>
                        <hr class="hr1">
                    </div>
