        ...
        <table width='100%' border='0' cellspacing='0' cellpadding='0'
            ...
            <tr>
				...
				<table border='0' align='right' cellpadding='0' cellspacing='0' style='font-size:13px;'>
                    <tr>
                        <td width='49'>
                            <div align='center'><img onclick="goPage(1, ${page.totalPage})" style="cursor:hand"
                                                     src='../../../images/main_54.gif' width='40' height='15'
                                                     border='0'/></div>
                        </td>
                        <td width='49'>
                            <div align='center'><img onclick="goPage(${page.currentPage-1}, ${page.totalPage})" style="cursor:hand"
                        ...
                        <td width='49'>
                            <div align='center'><img onclick="goPage(${page.totalPage}, ${page.totalPage})" style="cursor:hand"
                        ...
                        <td>
                            <div align='left'>
                                <select onchange="goPage(this.options[this.selectedIndex].value, ${page.totalPage})">
