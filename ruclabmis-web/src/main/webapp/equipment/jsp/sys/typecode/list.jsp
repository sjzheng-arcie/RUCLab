            ...
            <td valign="top" bgcolor="#F7F8F9">
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#F7F8F9">
	            	...
	            	<span class="STYLE1" style="white-space:nowrap">
						<a href="/equipment/jsp/sys/typecode/toAdd" class="txt_bt"><img src="../../../../images/add_min.gif" width="10"
                                                                         height="10" border="0"/>
                            <span class="STYLE1">新增</span></a>
      					<%--<a href="javascript:;" onclick="toUpdate('listForm', 'idcheckbox');"><img src="../../../../images/edit_min.gif" width="10" height="10"--%>
                                                               <%--border="0"/> <span class="STYLE1">修改</span></a>--%>
      					<a href="javascript:;" onclick="toDelete('listForm', 'idcheckbox');" class="txt_bt"><img
