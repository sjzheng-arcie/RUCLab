...
<tr class="noprint">
    ...
    <td valign="top" background="../../../../images/content-bg.gif">
        <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg"
            ...
            <tr>
                <td height="31">
                    <div class="titlebt">设备基本信息管理 > 实验设备报减销账</div>
                </td>
            </tr>
        </table>
    </td>
                ...
                <c:forEach items="${apply.equipments}" var="item">
                    <tr bgcolor="#ffffff" align="center" class="STYLE19">
                        ...
                        <c:if test="${formType=='apply'}">
                            <shiro:hasAnyRoles name="administrators,teacher,lab_admin,equipment_admin">
                                <td>
                                    <a href="/equipment/jsp/dev/deficit/removeEquipmentFromApply?application_id=${apply.applicationId}&equipment_id=${item.id}">
