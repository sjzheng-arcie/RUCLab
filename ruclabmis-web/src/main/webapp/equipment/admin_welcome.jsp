...
<div class="indexMainCon">
    <div class="indexNews">
        <h3><a href="/appointment/laboratory/jsp/announcement/remind/equipment/announcement" target="">更多>></a><span>系统公告</span></h3>
                ...
                <c:forEach items="${announcementList}" var="item">
                    <li><span><fmt:formatDate value="${item.publishTime}"></fmt:formatDate></span>
                        <a style="max-width: 200px"
                           href="/appointment/laboratory/jsp/announcement/remind/equipment/announcementDetail?announcementDetailId=${item.id}">${item.title}</a>
                    </li>
    ...
    <div class="indexNotice">
        <h3><a href="/appointment/laboratory/jsp/announcement/remind/equipment/message?page=1" target="">更多>></a><span>个人通知</span></h3>
                    ...
                    <li><span><fmt:formatDate value="${item.sendtime}"></fmt:formatDate></span>
                        <c:if test="${item.ifread==false}">
                            <a style="font-weight: bold "
                               href="/appointment/laboratory/jsp/announcement/remind/equipment/messageDetail?fatherPage=welcome&&messageDetailId=${item.id}&&page=1">${item.content}</a>
                        </c:if>
                        <c:if test="${item.ifread==true}">
                            <a href="/appointment/laboratory/jsp/announcement/remind/equipment/messageDetail?fatherPage=welcome&&messageDetailId=${item.id}&&page=1">${item.content}</a>
                        </c:if>
                    </li>
