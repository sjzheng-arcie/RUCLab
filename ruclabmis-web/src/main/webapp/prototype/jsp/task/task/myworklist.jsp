...
<head>
    ...
    <script>
        var baseHref = '/prototype/jsp/task/task/myworklist';
    </script>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        <td width="94%" valign="bottom"><span class="STYLE1" style="white-space:nowrap">工作列表</span>
                                        </td>
                                    </tr>
                                </table>
                            </td>
...
<tr>
    <td>
        <div id="divwidth" style="overflow:auto;overflow-y:hidden;">
            <table id="hello" width="100%" class="table" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                <tr>
                ...
                <tr bgcolor="#ffffff" align="center" class="STYLE19">
                    ...
                    <td>设备部署帮助手册</td>
                    <td>设备易损，注意安全</td>
                    <td><input type="text" value="20" style="width:20px">%<input type="button" value="保存" class="button"
                                                                                 onclick="score();"/></td>
                    <td><input type="button" value="详细" class="button" onclick="score();"/></td>
                </tr>
