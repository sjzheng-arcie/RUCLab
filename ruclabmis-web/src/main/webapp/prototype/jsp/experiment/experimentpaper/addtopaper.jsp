...
<head>
    ...
    <script>
        var baseHref = '/prototype/jsp/experiment/achievement/addtopaper';
    </script>
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td bgcolor="#FFFFFF">
                                    <table border="0" cellpadding="2" cellspacing="1"
                                        ...
                                        <tr>
                                            <td nowrap align="right">实验题描述:</td>
                                            <td nowrap>
                                                <input name="us_spwd" id="us_spwd" class="text" style="width:154px"
                                                       valid="required|isPassword" value="关于" readonly/>
                                                <span style="color:red;"> *</span> &nbsp;&nbsp;
                                            ...
                                            <td nowrap>
                                                <input name="us_spwd" id="us_spwd" class="text" style="width:154px"
                                                       valid="required|isPassword" value="刘洪亮" readonly/>
                                                <span style="color:red;"> *</span> &nbsp;&nbsp;
                                                <span style="color:red;" id="errMsg_us_spwd"></span>
                                            </td>
                                        </tr>
