...
CD.lang = {
    items: [
        ...
        ["-", "320", "3", "-1px 3px 0 4px", "", "�����"]
        ,
        ["fontname", "60", "20", "0 2px", "", "ѡ������"]
        ,
        ["fontsize", "80", "21", "0 2px", "", "�����С"]
        ,
        ["forecolor", "240", "20", "0 2px", "", "������ɫ"]
        ,
        ["backcolor", "260", "20", "0 2px", "", "������ɫ"]
        ,
        ["-", "320", "3", "-1px 3px 0 1px", "", "�����"]
        ,
        ["picture", "322", "22", "0", "", "����ͼƬ"]
        ...
        ["-", "320", "3", "-1px 4px 0 2px", "", "�����"]
        ,
        ["alignmode", "427", "21", "0 4px 0 0", "", "���뷽ʽ"]
        ,
        ["serial", "449", "22", "0 4px 0 0", "", "���"]
        ,
        ["indent", "470", "22", "0 4px 0 0", "", "����"]
    ],
    font: [
        ["����", "����"]
        ,
    ...
    size: [
        [1, "10px;line-height:12px;height:12px;", "С"]
        ,
        [2, "14px;line-height:16px;height:16px;", "��"]
        ,
        [4, "16px;line-height:18px;height:18px;", "��"]
        ,
        [5, "22px;line-height:24px;height:24px;", "�ϴ�"]
        ,
        [6, "30px;line-height:32px;height:32px;", "���"]
    ],
    color: [
        ['000000'],
        ['993300'],
    ...
    alignmode: [
        ["justifyleft", "100", "20", "-3px 0 0 0", "&nbsp;�����"]
        ,
        ["justifycenter", "120", "20", "-3px 0 0 0", "&nbsp;���ж���"]
        ,
        ["Justifyright", "140", "20", "-3px 0 0 0", "&nbsp;�Ҷ���"]
    ],
    serial: [
        ["insertorderedlist", "160", "20", "-3px 0 0 0", "&nbsp;���ֱ��"]
        ,
        ["insertunorderedlist", "180", "20", "-3px 0 0 0", "&nbsp;��Ŀ���"]
    ],
    indent: [
        ["indent", "220", "20", "-3px 0 0 0", "&nbsp;��������"]
        ,
        ["outdent", "200", "20", "-3px 0 0 0", "&nbsp;��������"]
    ]
};
CD.$ = function (i, win) {
    try {
...
CD.func = {
    ...
    getBrowser: function () {
        ...
        if (ua.indexOf("msie") > -1) browser = true;//IE�����
        return browser;
    },
    ...
    toolprompt: function (id, k, t) {
        ...
        switch (t) {
            ...
            case "picture" :
                ...
                d += "  <div unselectable='on'>ѡ���ϴ���";
                d += "<iframe frameborder='0' scrolling='no' src='" + CD.g[id].root + "upload.php?id=" + id + "_picture' style='width:260px;height:25px;'></iframe>";
                d += "</div>";
                d += "  <div>�����ַ��<input type='text' name='" + id + "_picture' id='" + id + "_picture' value='http://' class='editor_picture'></div>";
                d += "<div unselectable='on' style='margin-top:5px;padding-left:60px;'>";
                d += "<input id='" + id + "_link_" + t + "' para='InsertImage' type='button' value='��������' style='margin-left:2px;width:70px;'>";
                d += "<input type='button' value='ȡ��' style='margin-left:2px;' onclick='CD.func.fHide(\"" + id + "\");'>";
                d += "</div>";
                d += "</div>";
                break;
            case "createlink":
                d += "<div unselectable='on' style='width:200px;margin:8px 10px;'>";
                d += "<div unselectable='on'>���������ӵ�Ŀ���ַ��</div>";
                ...
                d += "<input id='" + id + "_link_" + t + "' para='createlink' type='button' value='ȷ��' style='margin-left:2px;'>";
                d += "<input type='button' value='ȡ��' style='margin-left:2px;' onclick='CD.func.fHide(\"" + id + "\");'>";
                d += "</div>";
                d += "</div>";
                break;
    ...
    CodeEditor: function (id, r) {
        ...
        if (o.codeMode) {
            ...
            CD.$(id + "_editor_source").innerHTML = "Ԥ��<b>&#187;</b>";
            CD.$(id + "_editor_source").title = "Ԥ��Ч��";
            if (o.filterMode) {
            ...
            CD.$(id + "_editor_source").title = "�༭HTMLԴ��";
...
CD.toolbar = {
    create: function (id) {
        ...
        tool += " unselectable='on' title='�༭HTMLԴ��'>&lt;HTML&gt;</div>";
        tool += "</div>";
        toolbar.innerHTML = tool;

        CD.event.add(toolbar, 'click', CD.func.ClickHandle);//����toolbar
        return toolbar;
    }
};