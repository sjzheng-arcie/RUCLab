...
function eXcell_stree(a) {
    ...
    this.edit = function () {
        ...
        this._sub.parentObject.style.top = b[1] +
            "px";
        this._sub.parentObject.style.left = b[0] + "px";
