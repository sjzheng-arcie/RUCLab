...
scheduler.locale = {date: {month_full: "一月,二月,三月,四月,五月,六月,七月,八月,九月,十月,十一月,十二月".split(","), month_short: "一月,二月,三月,四月,五月,六月,七月,八月,九月,十月,十一月,十二月".split(","), day_full: "星期日,星期一,星期二,星期三,星期四,星期五,星期六".split(","), day_short: "星期日,星期一,星期二,星期三,星期四,星期五,星期六".split(",")}, labels: {dhx_cal_today_button: "今天", day_tab: "日", week_tab: "周", month_tab: "月", new_event: "新事件", icon_save: "保存", icon_cancel: "取消", icon_details: "详细",
    icon_edit: "编辑", icon_delete: "删除", confirm_closing: "", confirm_deleting: "将要永久删除该事件，你确定吗？", section_description: "描述", section_time: "期间", full_day: "全天", confirm_recurring: "将要编辑所有重复的事件，你确定吗？", section_recurring: "Repeat event", button_recurring: "禁用", button_recurring_open: "启用", button_edit_series: "Edit series", button_edit_occurrence: "Edit occurrence", agenda_tab: "Agenda", date: "Date", description: "Description",
