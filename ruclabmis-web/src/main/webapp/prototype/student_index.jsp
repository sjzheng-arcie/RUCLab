...
<frameset rows="103,*" frameborder="NO" border="0" framespacing="0" name="mainFrame">
    <frame src="student_top" noresize="noresize" frameborder="NO" name="topFrame" scrolling="no" marginwidth="0"
           marginheight="0" target="main"/>
    <frameset cols="202,*" rows="2000,*" id="frame">
        <frame src="student_left" name="leftFrame" noresize="noresize" marginwidth="0" marginheight="0"
