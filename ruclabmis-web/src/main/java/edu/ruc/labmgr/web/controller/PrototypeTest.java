...
public class PrototypeTest {
	...
	public ModelAndView editInstructor(HttpServletRequest request) {

		ModelAndView mav = new ModelAndView("/laboratory/jsp/res/instructor/editpaper");
		return mav;
	}
	@RequestMapping("jsp/res/instructor/addtopaper")
	public ModelAndView addToInstructor(HttpServletRequest request) {
	...
	public ModelAndView instructorInfo(HttpServletRequest request) {
